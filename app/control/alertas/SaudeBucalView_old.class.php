 ...
 */
class SaudeBucalView extends \Adianti\Control\TPage {
    ...
    function __construct() {
        ...
        $this->html = new THtmlRenderer('app/resources/alertas/saudeBucal.html');
        ...
        $tipo='A38 - Saúde bucal primerissima infancia';
        ...
        //$action_select2->setField('tipo','A38 - Saúde bucal primerissima infancia');
        ...
        $panel1 = new TPanelGroup('A38 - Saúde bucal primerissima infancia');        
        //$panel1->add($html1); 
        $div = new TElement('div');
        $div->add( $c = new Grafico38BarChartView(false) );
