...
class ProtecaoCriancaView extends \Adianti\Control\TPage {
    ...
    function __construct() {
        ...
        $this->html = new THtmlRenderer('app/resources/alertas/protecaoCrianca.html');
        ...
        $tipo='A15 - Proteção a criança em situação de risco';
        ...
        //$action_select2->setField('tipo','A15 - Proteção a criança em situação de risco');
        ...
        $panel1 = new TPanelGroup('A15 - Proteção a criança em situação de risco');        
        //$panel1->add($html1); 
        $div = new TElement('div');
        $div->add( $c = new Grafico15BarChartView(false) );
        $panel1->add($div);       
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            $repository = new TRepository('Vw15AtendimentoEducacaoInfantil');
            $limit = 10;
            // creates a criteria
