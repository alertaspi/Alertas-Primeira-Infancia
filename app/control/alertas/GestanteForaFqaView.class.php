 ...
 */
class GestanteForaFqaView extends \Adianti\Control\TPage {
    ...
    function __construct() {
        ...
        //$html1 = new THtmlRenderer('app/resources/alertas/gestanteForaFqa.html');
        $this->html = new THtmlRenderer('app/resources/alertas/gestanteForaFqa.html');
        ...
        $tipo='A23 - Gestantes adolescentes fora do UBB';
        ...
        //$action_select2->setField('tipo','A23 - Gestantes adolescentes fora do UBB');
     ...
     public function onReload($param = NULL)
    {
        try
        {
            ...
            $repository = new TRepository('VwGravidezAdolecenciaAlerta');
            $limit = 10;
            // creates a criteria
