 ...
 */
class Grafico39BarChartView extends TPage
{
    /**
     * Class constructor
     * Creates the page
    ...
    function __construct( $show_breadcrumb = true )
    {
       ...
       count(*)  qtd
from scperfil.vw_39_imunizacao_primerissima_infancia
group by ano, mes_desc, idade";    
        ...
        */
        ...
        $panel = new TPanelGroup('A39 - Imunização na primerissima infância');
