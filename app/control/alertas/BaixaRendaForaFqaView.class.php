 ...
 */
class BaixaRendaForaFqaView extends \Adianti\Control\TPage {
    ...
    function __construct() {
        ...
        $this->form->setFormTitle('Vulnerabilidade');
        $html1 = new THtmlRenderer('app/resources/alertas/baixaRendaForaFqa.html');
        ...
        */
        ...
        $tipo='A37 - Gestantes em situação de vulnerabilidade fora do FQA';
        ...
        $panel1->add($html1);
        $div->add( $i = new VulnerabilidadeDadosPieChartView(false) );
        $panel1->add($div);
