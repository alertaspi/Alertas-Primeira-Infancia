<?php
/**
 * EntidadesFormList Form List
 * @author  <your name here>
 */
class EntidadesFormList extends TPage
{
    protected $form; // form
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Entidades
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new Entidades($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Entidades;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('dbpmbv'); // open a transaction
                $object = new Entidades($key); // instantiates the Active Record
