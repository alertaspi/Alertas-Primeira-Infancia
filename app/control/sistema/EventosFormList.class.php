<?php
/**
 * EventosFormList Form List
 * @author  <your name here>
 */
class EventosFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $evento_pai = new TDBCombo('evento_pai','dbpmbv', 'Eventos', 'id', 'nome');
        ...
        $this->form->addFields( [ new TLabel('Origem Id') ], [ $origem_id ] );
        $this->form->addFields( [ new TLabel('Data Info') ], [ $data_info ] );
        $this->form->addFields( [ new TLabel('Evento Pai') ], [ $evento_pai ] );
        ...
        $column_origem_id = new TDataGridColumn('origem_id', 'Origem Id', 'left');
        $column_data_info = new TDataGridColumn('data_info', 'Data Info', 'left');
        $column_evento_pai = new TDataGridColumn('evento_pai', 'Evento Pai', 'left');
        ...
        $this->datagrid->addColumn($column_evento_pai);
