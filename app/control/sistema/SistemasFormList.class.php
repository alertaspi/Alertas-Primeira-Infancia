<?php
/**
 * SistemasFormList Form List
 * @author  <your name here>
 */
class SistemasFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $entidade_id = new TDBCombo('entidade_id','dbpmbv','Entidades','id','nome');
        ...
        $column_icon_html = new TDataGridColumn('icon_html', 'Icon Html', 'left');
        $column_url = new TDataGridColumn('url', 'Url', 'left');
        $column_img = new TDataGridColumn('img', 'Img', 'left');
        ...
        $this->datagrid->addColumn($column_icon_html);
        $this->datagrid->addColumn($column_url);
        $this->datagrid->addColumn($column_img);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Sistemas
            $repository = new TRepository('Sistemas');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new Sistemas($key, FALSE); // instantiates the Active Record
