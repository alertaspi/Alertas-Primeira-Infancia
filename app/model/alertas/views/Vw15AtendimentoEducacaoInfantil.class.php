<?php
/**
 * Vw15AtendimentoEducacaoInfantil Active Record
 * @author  <your-name-here>
 */
class Vw15AtendimentoEducacaoInfantil extends TRecord
{
    const TABLENAME = 'scperfil.vw_15_atendimento_educacao_infantil';
