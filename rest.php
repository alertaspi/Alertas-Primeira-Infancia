        ...
        try
        {
            if (class_exists($class))
            {
                ...
                else
                {
                    ...
                    return json_encode( array('status' => 'error', 'data' => $error_message . " - Method Doesnt Exists"));
                }
            }
            else
            {
                $error_message = AdiantiCoreTranslator::translate('Class ^1 not found', $class);
                return json_encode( array('status' => 'error', 'data' => $error_message . " - Class Doesnt Exist"));
            }
        }
        catch (Exception $e)
        {
